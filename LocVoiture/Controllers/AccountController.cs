...
namespace LocVoiture.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            model.CINFile.SaveAs(@"C:\Users\Isaac\Desktop\devC#\PROJETS\LocVoiture\LocVoiture\Images\cin\" + model.CINFile.FileName);
            model.PCFile.SaveAs(@"C:\Users\Isaac\Desktop\devC#\PROJETS\LocVoiture\LocVoiture\Images\permis\" + model.PCFile.FileName);

            model.CIN = model.CINFile.FileName;
            model.PermisConduire = model.PCFile.FileName;

            var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Nom = model.Nom, Prenom = model.Prenom, CIN = model.CIN, PermisConduire = model.PermisConduire };
